...
# ╔═╡ 87a13d39-114b-4b57-a4f9-02445972f959
begin
	using Plots
	using PlutoUI
end

# ╔═╡ b741d461-342e-4c05-8445-0585aa4277ba
md"""
This is a test notebook that does a simple computation!
"""

# ╔═╡ 932d16aa-1c78-42dd-a51a-a97330e478c9
begin
	fslider = @bind f Slider(1:5)
	
	md"""
	**Choose the frequency**
	
	f = 1.0 $(fslider) 5.0 MHz

	"""
end

# ╔═╡ 582ea314-0f30-48e6-9836-cf2ac0c69fee
begin
	ts = 0.0:1e-3:5.0
	ω = 2π * f
end

# ╔═╡ 8603c513-ff22-4c28-9c5e-beda82d310d2
plot(ts, map(t -> sin(ω*t), ts); label=:none, xlabel = "time", title="f = $f MHz")
